"""
Low-latency benchmark for the NIXL backend.
Same as test_low_latency.py but initializes a NIXL buffer instead of NVSHMEM.
Calls the same test_main() so results are directly comparable.

Usage:
  Node 0:
    python3 test_low_latency_nixl.py --num-processes 1 --num-experts 32 --disable-nvlink

  Node 1:
    python3 test_low_latency_nixl.py --num-processes 1 --num-experts 32 --disable-nvlink --tcp-server <node0_ip>
"""
