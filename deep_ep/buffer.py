...
class Buffer:
    ...
    def connect_ranks(self, remote_ranks: List[int]) -> None:
        """
        Connect to remote ranks (NIXL mode). Handles NIXL metadata exchange
        via TCPStore or ETCD.
        ...
        if self.low_latency_mode:
            ...
            if self.group is not None:
                ...
                raise ValueError("Either 'group' or 'comm' must be configured for internode IPC.")
