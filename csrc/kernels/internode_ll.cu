...
void clean_buffer(void* clean_0, int num_clean_int_0,
                  ...
                  int* mask_buffer, int* sync_buffer,
                  cudaStream_t stream) {
    constexpr int kNumThreads = 256;
    deep_ep::gpu_nixl_ctx dummy_ctx = {};
    dummy_ctx.rank = rank;
    dummy_ctx.max_num_ranks = num_ranks;
    dummy_ctx.sync_buffer_ptr = sync_buffer;
