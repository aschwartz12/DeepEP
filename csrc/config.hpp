...
#ifdef USE_NIXL
using ll_count_t = uint64_t;
#else
using ll_count_t = int;
#endif
...
struct LowLatencyBuffer {
    ...
    ll_count_t* dispatch_rdma_recv_count_buffer = nullptr;

    void* combine_rdma_send_buffer = nullptr;
    void* combine_rdma_recv_data_buffer = nullptr;
    ll_count_t* combine_rdma_recv_flag_buffer = nullptr;

    void* combine_rdma_send_buffer_data_start = nullptr;
    size_t num_bytes_per_combine_msg = 0;

    std::pair<ll_count_t*, int> clean_meta() {
...
struct LowLatencyLayout {
    ...
    LowLatencyLayout(void* rdma_buffer, int num_max_dispatch_tokens_per_rank, int hidden, int num_ranks, int num_experts) {
        ...
        size_t dispatch_recv_count_buffer_bytes = num_experts * sizeof(ll_count_t);
        ...
        for (int i = 0; i < 2; ++i) {
            buffers[i] = {static_cast<int>(signaling_buffer_bytes / sizeof(ll_count_t)),
                          ...
                          advance<ll_count_t*>(rdma_buffer, signaling_buffer_bytes_aligned * i),
                          advance(rdma_buffer, signaling_buffer_bytes_aligned * 2 + send_buffer_bytes * i),
                          advance(rdma_buffer, signaling_buffer_bytes_aligned * 2 + send_buffer_bytes * 2 + recv_buffer_bytes * i),
                          advance<ll_count_t*>(rdma_buffer, signaling_buffer_bytes_aligned * i),
                          advance(rdma_buffer, signaling_buffer_bytes_aligned * 2 + send_buffer_bytes * i),
